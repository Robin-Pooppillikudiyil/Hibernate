package com.hibernatelean.enterprise.hibernate;
...
public class App {
	...
	public static void main(String[] args) {
		...
		Employee em1 = new Employee("Robin Thomas", 25);
		Employee em2 = new Employee("Joby Thomas", 32);
		Employee em3 = new Employee("Jibin Thomas", 29);
